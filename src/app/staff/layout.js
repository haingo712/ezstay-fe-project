      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-purple-600 dark:text-purple-400 font-medium">Staff Panel</p>
            </div>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 dark:text-white">Staff Manager</p>
              <p className="text-xs text-gray-500 dark:text-gray-400">staff@ezstay.com</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between h-16 px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:flex items-center space-x-2">
                <Link
                  href="/staff/moderation"
                  className="px-3 py-1 text-xs font-medium text-purple-700 bg-purple-100 rounded-full hover:bg-purple-200 dark:bg-purple-900 dark:text-purple-200 dark:hover:bg-purple-800 transition-colors"
                >
                  5 Pending
                </Link>
                <Link
