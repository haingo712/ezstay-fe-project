...
export default function OwnerLayout({ children }) {
  ...
  const isActive = (href) => {
    ...
    if (href !== '/owner' && pathname.startsWith(href)) return true;
    return false;
  };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex">
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform ${
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700 mt-16 lg:mt-0">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Owner Panel</h2>
            <button
        ...
        <div className="flex-1 lg:ml-64">
          {/* Mobile menu button */}
          <div className="lg:hidden flex items-center justify-between h-16 px-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 mt-16">
            <button
            ...
            <h1 className="text-lg font-semibold text-gray-900 dark:text-white">Owner Panel</h1>
            <div></div>
          </div>

          {/* Page content */}
          <main className="p-6 lg:mt-16">
            {children}
          </main>
        </div>
      </div>
