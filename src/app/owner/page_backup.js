...
export default function OwnerDashboard() {
  ...
  // Mock owner ID - trong thực tế sẽ lấy từ user.id
  const ownerId = user?.id || "123e4567-e89b-12d3-a456-426614174000";
  ...
  const loadDashboardData = async () => {
    try {
      ...
      setError("Unable to load your properties. Please check your connection.");
